...
- [ ] Explain what a token is used for.
  ...
  it saves the users login information on their maching so they dont have to login every time.

- [ ] What steps can you take in your web apps to keep your data secure?

  By creating private routes for users personal information protected by passwords and JSON web tokens.

- [ ] Describe how web servers work.

  They store, process, and deliver information to clients through HTTP.
